package com.HesperusMarketing.channelbridgews;

import android.content.Context;
import android.content.SharedPreferences;
import android.util.Log;

import com.HesperusMarketing.Entity.CreditPeriod;
import com.HesperusMarketing.Entity.DealerSaleEntity;
import com.HesperusMarketing.Entity.ReturnHeaderEntity;
import com.HesperusMarketing.channelbridgedb.Approval_Persons;
import com.HesperusMarketing.channelbridgedb.Invoice;
import com.HesperusMarketing.channelbridgedb.ReturnHeader;
...
public class WebService {
    ...
    //public final String SOAP_ADDRESS = "http://220.247.244.22:9595/CherubiumTest_Sri/WebServices/WebServiceChannelBridge.asmx";
    // public final String SOAP_ADDRESS = "http://220.247.219.27:8085/CherubiumTest/WebServices/WebServiceChannelBridge.asmx";
    // public final String SOAP_ADDRESS = "http://203.189.69.202:8082/HesCBMul/WebServices/WebServiceChannelBridge.asmx";
    //public final String SOAP_ADDRESS = "http://220.247.244.22:8082/CB_Demo/WebServices/WebServiceChannelBridge.asmx";
    //public final String SOAP_ADDRESS = "http://220.247.244.22:8082/CB_NEW/WebServices/WebServiceChannelBridge.asmx";


    //test
   // public final String SOAP_ADDRESS = "http://122.255.14.49:5555/HesCBMulTest_H/WebServices/WebServiceChannelBridge.asmx";
  // public final String SOAP_ADDRESS = "http://192.168.0.139:2222/CBWebPortal/WebServices/WebServiceChannelBridge.asmx";
  //  http://192.168.0.73:2222/CBWebPortal/WebServices/WebServiceChannelBridge.asmx


   public final String SOAP_ADDRESS = "http://220.247.244.22:3332/HesCBMulTest_H/WebServices/WebServiceChannelBridge.asmx";
 // public final String SOAP_ADDRESS = "http://192.168.0.73:2222/CBWebPortal/WebServices/WebServiceChannelBridge.asmx";
...
//		Log.w("test123", "list size : " + repDetailList.size());
                ...
                if (custTable != null && custTable.getPropertyCount() > 0) {
                    ...
                    for (int i = 0; i < custTable.getPropertyCount(); i++) {
                        ...
                        if (custDetails.hasProperty("CurrentCredit")) {//test
                            ...
                            if (custDetails.getProperty("CurrentCredit").toString() != "anyType{}") {
                                customerDetails[33] = custDetails.getProperty("CurrentCredit").toString();
                            } else {
                                customerDetails[33] = "";
                            }
                        }
            ...
            if (response != null && response.getPropertyCount() > 0) {
                ...
                if (prodTable != null && prodTable.getPropertyCount() > 0) {
                    ...
                    for (int i = 0; i < prodTable.getPropertyCount(); i++) {
                        String[] prodDetails = new String[24];
                        ...
                        if (prductDetails.hasProperty("priority")) {
                            prodDetails[18] = prductDetails.getProperty("priority")
                                    .toString();
                        }
                        if (prductDetails.hasProperty("SortOrder")) {
                            prodDetails[19] = prductDetails.getProperty("SortOrder")
                                    .toString();
                        }
                        if (prductDetails.hasProperty("DescriptionPrint")) {
                            prodDetails[20] = prductDetails.getProperty("DescriptionPrint")
                                    .toString();
                        }
                        if (prductDetails.hasProperty("PrincipleSortOrder")) {
                            prodDetails[21] = prductDetails.getProperty("PrincipleSortOrder")
                                    .toString();
                        }
    ...
    public String uploadInvoiceDetails(String deviceId, String repId, ArrayList<String[]> invoicedProductDetailList) throws SocketException {
        ...
        for (String[] invoicedProduct : invoicedProductDetailList) {
            ...
            table.addProperty("Date", invoicedProduct[13].replace("-","/"));
        ...
        SoapObject invoiceData = new SoapObject(WSDL_TARGET_NAMESPACE, "InvoiceData");
    ...
    public String uploadShelfQuantityDetails(String deviceId, String repId, String[] rtnProduct) throws SocketException {
    ...
    public ArrayList<String[]> getProductList(String deviceId, String repId, String maxRowId) throws SocketException {
    ...
    public ArrayList<String[]> getCustomerList(String deviceId, String repId, String maxRowId) throws SocketException {
        ...
        try {
            ...
            if (response != null && response.getPropertyCount() > 0) {
                ...
                if (custTable != null && custTable.getPropertyCount() > 0) {
                    ...
                    for (int i = 0; i < custTable.getPropertyCount(); i++) {
                        String[] customerDetails = new String[36];//test
                        SoapObject custDetails = (SoapObject) custTable
                                .getProperty(i);
                        ...
                        if (custDetails.hasProperty("Longitude")) {
                            ...
                            if (custDetails.getProperty("Longitude").toString() != "anyType{}") {
                                customerDetails[29] = custDetails.getProperty("Longitude").toString();
                            } else {
                                customerDetails[29] = "";
                            }
                        }
...
//		Log.w("test123", "list size : " + repDetailList.size());
    ...
    public String uploadCollectionInvoiceTask(String repId, String[] custDetails) throws SocketException {

        String repStoreDetailList = "";

        final String SOAP_ACTION = "http://tempuri.org/xmlSetCollectionInvoice";

        final String OPERATION_NAME = "xmlSetCollectionInvoice";
        ...
        table.addProperty("KEY_COLLECTIONNOTE_NO", custDetails[0]);
        table.addProperty("KEY_INVOICE_NO", custDetails[1]);
        table.addProperty("KEY_PAYMENT_TYPE", custDetails[2]);
        table.addProperty("KEY_CREDIT_AMOUNT", custDetails[3]);
        table.addProperty("KEY_CASH_AMOUNT", custDetails[4]);
        table.addProperty("KEY_CHEQES_AMOUNT", custDetails[5]);



        dataset.addSoapObject(table);

        SoapObject invoiceData = new SoapObject(WSDL_TARGET_NAMESPACE, "CollectionNote");
        invoiceData.addSoapObject(dataset);
        request.addSoapObject(invoiceData);
    ...
    public String uploadCollectionChequeTask(String repId, String[] custDetails) throws SocketException {
        ...
        final String SOAP_ACTION = "http://tempuri.org/xmlSetCollectionCheque";
        ...
        SoapObject table = new SoapObject(WSDL_TARGET_NAMESPACE, "Table");
        table.addProperty("KEY_COLLECTIONNOTE_NO", custDetails[0]);
        table.addProperty("KEY_CHEQUENUMBER", custDetails[1]);
        table.addProperty("KEY_CHEQUEAMOUNT", custDetails[2]);
        table.addProperty("KEY_COLLECT_DATE", custDetails[3]);
        table.addProperty("KEY_BANK", custDetails[4]);
        table.addProperty("KEY_BRANCH", custDetails[5]);
        table.addProperty("KEY_REALIZED_DATE", custDetails[6]);
        table.addProperty("KEY_CHEQUE_IMAGE", custDetails[7]);
            ...
            if (response != null && response.getPropertyCount() > 0) {
                ...
                if (repStoreTable != null
                    ...
                    for (int i = 0; i < repStoreTable.getPropertyCount(); i++) {
                        ...
                        if (prductDetails.hasProperty("BranchCode")) {
                            prodDetails[6] = prductDetails.getProperty("BranchCode")
                                    .toString();
                        }
                        if (prductDetails.hasProperty("BankCode")) {
                            prodDetails[7] = prductDetails.getProperty("BankCode")
                                    .toString();
                        }
            ...
            if (response != null && response.getPropertyCount() > 0) {
                ...
                if (repStoreTable != null
                    ...
                    for (int i = 0; i < repStoreTable.getPropertyCount(); i++) {
                        ...
                        if (prductDetails.hasProperty("BankCode")) {
                            prodDetails[4] = prductDetails.getProperty("BankCode")
                                    .toString();
                        }
    ...
    public String uploadInvoiceOutstandingDetails(String deviceId, String repId, String[] invoiceOutstanding) throws SocketException {
        ...
        table.addProperty("Date", invoiceOutstanding[2].replace("-","/"));
        ...
        SoapObject invoiceData = new SoapObject(WSDL_TARGET_NAMESPACE, "OutstandingData");
        invoiceData.addSoapObject(dataset);
        request.addSoapObject(invoiceData);
        ...
        try {
            ...
            if (response != null && response.getPropertyCount() > 0) {
                ...
                returnString = response.getProperty("xmlSetOutstandingResult").toString();
    ...
    public String uploadInvoiceChequeDetails(String deviceId, String repId, String[] invoiceCheque) throws SocketException {
    ...
    public ArrayList<String[]> getGetUnloadingStatus(String deviceId, String repId, String rowIds) throws SocketException {
...
//		Log.w("test123", "list size : " + repDetailList.size());
    ...
    public String SetUnloadingDetails(String deviceId, String repId, String[] unloadDetails) throws SocketException {
    ...
    public String uploadExpirewarning(String deviceId, String repId, String[] custDetails) throws SocketException {
                ...
                if (custTable != null && custTable.getPropertyCount() > 0) {
                  ...
                  /*  repDetailList = new ArrayList<String[]>(
                    ...
                    for (int i = 0; i < custTable.getPropertyCount(); i++) {
                        ...
                        Log.w("Log", "repDetails object : " + custDetails.toString());

                        if (custDetails.hasProperty("CusImage")) {
                            if (custDetails.getProperty("CusImage").toString() != "anyType{}") {
                                customerDetails[0] = custDetails.getProperty("CusImage").toString();
                            } else {
                                customerDetails[0] = "";
                            }
                        }
                        if (custDetails.hasProperty("ImageID")) {
                            ...
                            if (custDetails.getProperty("ImageID").toString() != "anyType{}") {
                                customerDetails[1] = custDetails.getProperty("ImageID").toString();
                            } else {
                                customerDetails[1] = "";
                            }
                        }
...
//                Log.w("Log", "Data set : " + dataset.toString());
    ...
    public void uploadInvoiceHeader(String deviceId, String repId, String dealerId, List<String[]> headerList) {
        ...
        for (String[] headerItem : headerList) {
            ...
            Log.i("inside loop 0-->", headerItem[0]);
            Log.i("inside loop 1-->", headerItem[1]);
            Log.i("inside loop 2-->", headerItem[2]);
            Log.i("inside loop 3-->", headerItem[3]);
            Log.i("inside loop 4-->", headerItem[4]);
            Log.i("inside loop 5-->", headerItem[5]);
            Log.i("inside loop 6-->", headerItem[6]);
            Log.i("inside loop 7-->", headerItem[7]);
            Log.i("inside loop 8-->", headerItem[8]);
            Log.i("inside loop 9-->", headerItem[9]);
            Log.i("inside loop 10-->", headerItem[10]);
            Log.i("inside loop 11-->", headerItem[11]);
            Log.i("inside loop 12-->", headerItem[12]);
            Log.i("inside loop 13-->", headerItem[13]);
            Log.i("inside loop 14-->", headerItem[14]);
            Log.i("inside loop 15-->", headerItem[15]);
            Log.i("inside loop 16-->", headerItem[16]);
            Log.i("inside loop 17-->", headerItem[17]);
            Log.i("inside loop 18-->", headerItem[18]);
            Log.i("inside loop 19-->", headerItem[19]);
...
//    private String convertDate(String start_dt){
//
...
//    }
    ...
    public ArrayList<String[]> getProductImageDetails(String repId, String deviceId) throws SocketException {

        ArrayList<String[]> productImageDetailList = null;
        final String SOAP_ACTION = "http://tempuri.org/xmlGetProductImages";
        final String OPERATION_NAME = "xmlGetProductImages";
        ...
        PropertyInfo piTwo = new PropertyInfo();
        piTwo.setName("DeviceID");
        piTwo.setValue(deviceId);
        piTwo.setType(String.class);
        request.addProperty(piTwo);
...
//            System.out.println("response response :"+response);
            if (response != null && response.getPropertyCount() > 0) {
                SoapObject custTable = (SoapObject) response.getProperty(0);
                if (custTable != null && custTable.getPropertyCount() > 0) {
                    productImageDetailList = new ArrayList<String[]>(custTable.getPropertyCount());
                    for (int i = 0; i < custTable.getPropertyCount(); i++) {
                        String[] customerDetails = new String[6];
                        SoapObject custDetails = (SoapObject) custTable.getProperty(i);

                        if (custDetails.hasProperty("ID")) {
                            customerDetails[0] = custDetails.getProperty("ID").toString();
                        }
                        if (custDetails.hasProperty("ItemCode")) {
                            customerDetails[1] = custDetails.getProperty("ItemCode").toString();
                        }

                        if (custDetails.hasProperty("ImageUrl")) {
                            customerDetails[2] = custDetails.getProperty("ImageUrl").toString();
                        }else {
                            customerDetails[2]="0";
                        }

                        if (custDetails.getProperty("DisplayCode").toString().equals("anyType{}")) {
                            customerDetails[3] = "";
                        } else {
                            customerDetails[3] = custDetails.getProperty("DisplayCode").toString();
                        }
                        if (custDetails.getProperty("SequenceNo").toString().equals("anyType{}")) {
                            customerDetails[4] = "";
                        } else {
                            customerDetails[4] = custDetails.getProperty("SequenceNo").toString();

                        }


                        productImageDetailList.add(customerDetails);
                    }

                } else {
                    productImageDetailList = new ArrayList<String[]>(0);
                }
            } else {
                productImageDetailList = new ArrayList<String[]>(0);
            }
            ...
            productImageDetailList = null;
            System.out.println(" exception getProductImageDetails :"+exception);
    ...
    public ArrayList<String[]> getDiscountStructures(String repid) {
        ...
        final String SOAP_ACTION = "http://tempuri.org/xmlfreediscountdetailsDefault";
        final String OPERATION_NAME = "xmlfreediscountdetailsDefault";
        SoapObject request = new SoapObject(WSDL_TARGET_NAMESPACE, OPERATION_NAME);
...
*/
            ...
            if (response != null && response.getPropertyCount() > 0) {
                ...
                if (desicountTable != null && desicountTable.getPropertyCount() > 0) {
                    ...
                    for (int i = 0; i < desicountTable.getPropertyCount(); i++) {
                        ...
                        if (discountDetails.hasProperty("ID")) {
                            Details[0] = discountDetails.getProperty("ID").toString();
                        }
                        if (discountDetails.hasProperty("Brand")) {
                            Details[1] = discountDetails.getProperty("Brand").toString();
                        }
                        if (discountDetails.hasProperty("CustomerCategoryID")) {
                            Details[2] = discountDetails.getProperty("CustomerCategoryID").toString();
                        }
                        if (discountDetails.hasProperty("OrderQTY")) {
                            Details[3] = discountDetails.getProperty("OrderQTY").toString();
                        }
                        if (discountDetails.hasProperty("FreeQTY")) {
                            Details[4] = discountDetails.getProperty("FreeQTY").toString();
                        }
    ...
    public ArrayList<String[]> getChequeDetails(String repid) {

        ArrayList<String[]> DetailList = null;
        final String SOAP_ACTION = "http://tempuri.org/xmlPendingCollectionNote";
        final String OPERATION_NAME = "xmlPendingCollectionNote";
        SoapObject request = new SoapObject(WSDL_TARGET_NAMESPACE, OPERATION_NAME);
        ...
        try {
            ...
            if (response != null && response.getPropertyCount() > 0) {
                ...
                if (cheqTable != null && cheqTable.getPropertyCount() > 0) {
                    DetailList = new ArrayList<String[]>(cheqTable.getPropertyCount());

                    for (int i = 0; i < cheqTable.getPropertyCount(); i++) {
                        String[] Details = new String[12];//test
                        SoapObject discountDetails = (SoapObject) cheqTable.getProperty(i);


                        if (discountDetails.hasProperty("ID")) {
                            Details[0] = discountDetails.getProperty("ID").toString();
                        }
                        if (discountDetails.hasProperty("CUSTOMERNO")) {
                            Details[1] = discountDetails.getProperty("CUSTOMERNO").toString();
                        }
                        if (discountDetails.hasProperty("COLLECTIONNOTENO")) {
                            Details[2] = discountDetails.getProperty("COLLECTIONNOTENO").toString();
                        }
                        if (discountDetails.hasProperty("InvoiceNo")) {
                            Details[3] = discountDetails.getProperty("InvoiceNo").toString();
                        }
                        if (discountDetails.hasProperty("PAYMENTTYPE")) {
                            Details[4] = discountDetails.getProperty("PAYMENTTYPE").toString();
                        }
                        if (discountDetails.hasProperty("CHEQUENUMBER")) {
                            Details[5] = discountDetails.getProperty("CHEQUENUMBER").toString();
                        }
                        if (discountDetails.hasProperty("CHEQUEAMOUNT")) {
                            Details[6] = discountDetails.getProperty("CHEQUEAMOUNT").toString();
                        }

                        if (discountDetails.hasProperty("INSERTDATE")) {
                            Details[7] = discountDetails.getProperty("INSERTDATE").toString();
                        }
                        if (discountDetails.hasProperty("ISREJECTED")) {
                            Details[8] = discountDetails.getProperty("ISREJECTED").toString();
                        }
                        if (discountDetails.hasProperty("IsRealized")) {
                            Details[9] = discountDetails.getProperty("IsRealized").toString();
                        }
                        if (discountDetails.hasProperty("IsBounzed")) {
                            Details[10] = discountDetails.getProperty("IsBounzed").toString();
                        }
                        if (discountDetails.hasProperty("IS_APPROVED")) {
                            Details[11] = discountDetails.getProperty("IS_APPROVED").toString();
                        }
