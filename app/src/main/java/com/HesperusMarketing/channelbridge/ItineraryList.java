...
import com.HesperusMarketing.channelbridgebs.UploadAttendenceTask;
import com.HesperusMarketing.channelbridgedb.Attendence;
...
import com.HesperusMarketing.channelbridgehelp.VideoListDemoActivity;
...
//			USER_LOGIN = extras.getString("UserLogin");			
    ...
    public boolean onQueryTextChange(String newText) {
        ...
        // alertDialog.setMessage("test : "+ newText);
        // alertDialog.show();
        return false;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.menu_addCustomer:
                ...
                Intent addCustomerIntent = new Intent(
                        "com.HesperusMarketing.channelbridge.ADDCUSTOMERACTIVITY");
            ...
            case R.id.menu_extraCustomer:
                ...
                if (extraCustomerEnabled) {
                    ...
                    Intent extraCustomerIntent = new Intent(
                            "com.HesperusMarketing.channelbridge.EXTRACUSTOMERACTIVITY");
                    startActivity(extraCustomerIntent);
                } else {
                    Toast noMatchesFound = Toast.makeText(getApplication(),
                            "This feature is not availabe.", Toast.LENGTH_SHORT);
                    noMatchesFound.show();
                }

                break;
            case R.id.menu_CompetitorProducts:
                Intent startCompetitorProducts = new Intent(
                        "com.HesperusMarketing.channelbridge.COMPETITORPRODUCTACTIVITY");
                startActivity(startCompetitorProducts);
                break;

            case R.id.menu_preference:
                Intent preferences = new Intent("com.HesperusMarketing.channelbridge.PREF");
                finish();
            ...
            case R.id.menu_repStore:
                ...
                Intent repStore = new Intent(
                        "com.HesperusMarketing.channelbridge.PRODUCTREPSTOREACTIVITY");
                finish();
                startActivity(repStore);
                break;

            case R.id.menu_priceList:
                Intent priceListIntent = new Intent(
                        "com.HesperusMarketing.channelbridge.PRICELISTACTIVITY");
                finish();
            ...
            case R.id.menu_syncronizePreference:
                Intent syncronizePreferences = new Intent(
                        "com.HesperusMarketing.channelbridge.SYNCRONIZEPREFERENCE");
                finish();
            ...
            case R.id.menu_about:
                Intent about = new Intent(
                        "com.HesperusMarketing.channelbridge.ABOUTAPPLICATION");
                finish();
                startActivity(about);
                break;
            case R.id.menu_repAddence:
                ...
                Intent attendence = new Intent(
                        "com.HesperusMarketing.channelbridge.RepAttendance");
          ...
          //   Intent startItinerary = new Intent(ItineraryList.this, Test.class);
            ...
            case R.id.menu_report:
                ...
                Intent reportIntent = new Intent(
                        "com.HesperusMarketing.channelbridge.Report");
