...
import com.HesperusMarketing.channelbridge.ItineraryList.DetailsActivity;
...
//				getListView().setSelector(R.color.itinerary_list_selector);
                ...
                if (mDualPane) {
                    ...
                    showDetails(itineraryListId.get(getRowIdSelect()),
                            getRowIdSelect());
                }
...
//			}
            ...
            ItineraryDetailsFragment details = (ItineraryDetailsFragment) getFragmentManager()
    ...
    public List<String> getItineryNameList() {
        ...
        for (String[] ItineraryData : result) {
            ...
            Log.w("INVOICED STATUS - 1234567890", ItineraryData[0]);
