    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        iBtnPrint.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String printData = "         Hesperus Marketing (pvt.) ltd\n";
                printData = printData + "No. 100, 5th Lane ,Colombo 03\n";
                printData = printData + "       TP. +94 11 2576736\n";
                printData = printData + "  Athorized Distributor for Hesperus Marketing\n";
                printData = printData + "\n\n";
                ...
                printData = printData + "   Powered By : eMerge Solutions(Pvt)Ltd.\n";
                printData = printData + "             Tel: 011 5 960 960\n";
