...
import com.HesperusMarketing.channelbridgebs.DownloadCustomerImagesTask;
import com.HesperusMarketing.channelbridgebs.DownloadDealerSalesTask;
import com.HesperusMarketing.channelbridgebs.Download_Branch;
...
import com.HesperusMarketing.channelbridgedb.AutoSyncOnOffFlag;
...
import com.HesperusMarketing.channelbridgedb.ProductUnload;
import com.HesperusMarketing.channelbridgedb.Product_Image;
...
public class SyncronizePreference extends PreferenceActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        addPreferencesFromResource(com.HesperusMarketing.channelbridge.R.xml.syncronize_preference);
     ...
     //           new PreferenceOnClickListener());
        ...
        findPreference("DownloadDealerSales").setOnPreferenceClickListener(
                new PreferenceOnClickListener());
        findPreference("DownloadApproval").setOnPreferenceClickListener(
                new PreferenceOnClickListener());

        findPreference("DownloadProductImage").setOnPreferenceClickListener(
                new PreferenceOnClickListener());
...
//        }
    ...
    private  class DownloadCreditPeriods extends AsyncTask<Void,Void,Void>{
      ...
      public  DownloadCreditPeriods(Context context){
        ...
        protected void onPostExecute(Void aVoid) {
            ...
            com.HesperusMarketing.channelbridgedb.CreditPeriod periodController = new com.HesperusMarketing.channelbridgedb.CreditPeriod(SyncronizePreference.this);
    ...
    private class PreferenceOnClickListener implements Preference.OnPreferenceClickListener {
        public boolean onPreferenceClick(Preference preference) {
            ...
            }else if(preference.getKey().equals("DownloadApproval")){
                new DownloadApprovedPerson(SyncronizePreference.this).execute();
            }
            else if(preference.getKey().equals("DownloadProductImage")){
                new DownloadProductImage(SyncronizePreference.this).execute();
            }
                    ...
                    for (String[] invoicedProduct : invoicedProducts) {
                        ...
                        String[] productRepStor = productRepStore
                                .getProductDetailsByProductBatchAndProductCode(
                                        invoicedProduct[3], invoicedProduct[2]);
                        ...
                        if (invoicedProduct[7] != ""
                            ...
                            String[] invoiceDetails = new String[17];
...
//					invoiceDetails[2] = "R"; // Issue mode
            ...
            if (isOnline()) {
                ...
                if (repStoreDataResponse.size() > 0) {
                    ...
                    for (int i = 0; i < repStoreDataResponse.size(); i++) {
                        ...
                        productRepStore.openReadableDatabase();
                        flag = productRepStore.isBatchAvailable(custDetails[5],
                                custDetails[2]);
                        productRepStore.closeDatabase();

                        if (!flag) {
                            productRepStore.openWritableDatabase();
                            Long result = productRepStore
                                    .insertProductRepStore(custDetails[0],
                            ...
                            productRepStore.openWritableDatabase();
                            long result = productRepStore
                                    .updateProductRepstore(custDetails[5],
                                            String.valueOf(quantity),
                                            custDetails[4], timeStamp,
                                            custDetails[0]);
    ...
    private class UploadCustomerImageTask extends AsyncTask<String, Integer, Integer> {
                    ...
                    for (String[] rtnProdData : rtnProducts) {
                        ...
                        try {
                            con.connect(SyncronizePreference.this
                                    .getString(com.HesperusMarketing.channelbridge.R.string.ftp_host), Integer
                                    .parseInt(SyncronizePreference.this
                                            .getString(com.HesperusMarketing.channelbridge.R.string.ftp_port)));
                            if (con.login(SyncronizePreference.this
                                            .getString(com.HesperusMarketing.channelbridge.R.string.ftp_username),
                                    SyncronizePreference.this
                                            .getString(com.HesperusMarketing.channelbridge.R.string.ftp_password))) {
                    ...
                    for (int i = 0; i < repStoreDataResponse.size(); i++) {
                        ...
                        if (flag) {
                            ...
                            Long result = products.updateProduct(
                                    ...
                                    custDetails[17].trim(), custDetails[18], custDetails[19]);
                            ...
                            Long result = products.insertProduct(
                                    ...
                                    custDetails[14], custDetails[15],
                                    custDetails[16], timeStamp,
                                    custDetails[17].trim(),custDetails[18],custDetails[19],custDetails[20],custDetails[21]);
                    ...
                    for (int i = 0; i < repStoreDataResponse.size(); i++) {
                        ...
                        if (isAvailable) {
                            ...
                            Long result = customers.insertCustomer(
                                    ...
                                    custDetails[34],
                                    custDetails[35]
                                    // Byte.parseByte(custDetails[32])//btnAdd image sk
                            );
                            customers.closeDatabase();
...
//					unloadProdDetails[3] ="14/03/2013";
    ...
    private class DownloadApprovedPerson extends AsyncTask<String, Integer, Integer> {

        private final Context context;
        ArrayList<String[]> responseArr=null;
        public DownloadApprovedPerson(Context context) {
        ...
        protected void onPreExecute() {
            ...
            dialog = new ProgressDialog(context);
            dialog.setCancelable(false);
            dialog.setMessage("Download Approved Person...");
            dialog.setProgressStyle(ProgressDialog.STYLE_SPINNER);
            dialog.setProgress(0);
        ...
        protected void onPostExecute(Integer returnCode) {
            ...
            try {
                Approval_Persons approvedperson = new Approval_Persons(SyncronizePreference.this);
            ...
            if (isOnline()) {
               while (responseArr == null) {
                    try {
                        ...
                        WebService webService = new WebService();
                        responseArr = webService.getApprvedList(repId);
                        Thread.sleep(100);
    ...
    private class DownloadProductImage extends AsyncTask<String, Integer, Integer> {
        ...
        protected void onPreExecute() {
            ...
            dialog = new ProgressDialog(context);
            dialog.setCancelable(false);
            dialog.setMessage("Download Product Image...");
            dialog.setProgressStyle(ProgressDialog.STYLE_SPINNER);
            dialog.setProgress(0);
    ...
    public class DownloadImage extends AsyncTask<String, Integer,Void>{
        ...
        protected Void doInBackground(String... strings) {
            ...
            try {
                repStoreDataResponse = webService.getProductImageDetails(strings[0], strings[1]);
