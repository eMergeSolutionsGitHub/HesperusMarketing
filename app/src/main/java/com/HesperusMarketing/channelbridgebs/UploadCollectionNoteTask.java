        ...
        if (isNetworkAvailable() == true) {
            try {
                ...
                for (String[] rtnProdData : rtnProducts) {
                    ...
                    String[] invoiceDetails = new String[21];
                    ...
                    invoiceDetails[17] = rtnProdData[17];
                    invoiceDetails[18] = rtnProdData[18];
                    invoiceDetails[19] = rtnProdData[19];

                   Log.i("tag rep", ""+invoiceDetails[2]);
                    Log.i("tag rep name", ""+invoiceDetails[18]);

                    Log.i("tag rep 17", ""+invoiceDetails[17]);
                    Log.i("tag rep 19", ""+invoiceDetails[19]);


                    System.out.println("sssssss : " + invoiceDetails[19]);
