            ...
            //    try {
                    ...
                    for (String[] invoiceData : invoice) {
                        ...
                        for (String[] invoicedProduct : invoicedProducts) {
                            ...
                            Log.w("Log", "req invoicedProduct :  " + invoicedProduct[4]);
                        ...
                        for (String[] invoicedProduct : invoicedProducts) {
                            ...
                            String[] productRepStor = productRepStore
                                    .getProductDetailsByProductBatchAndProductCode(invoicedProduct[3], invoicedProduct[2]);
