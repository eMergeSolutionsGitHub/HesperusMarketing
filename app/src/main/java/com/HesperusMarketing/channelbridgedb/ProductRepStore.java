...
//	   Cursor cursor = database.rawQuery(queryStr, null);
    ...
    public ArrayList<Product> getAllRepAtoreDetails() {
        ...
        Cursor cursor = database.rawQuery("select * from products  inner join productRepStore  on products.code = productRepStore.product_code order by products.sortOrder ASC", null);
