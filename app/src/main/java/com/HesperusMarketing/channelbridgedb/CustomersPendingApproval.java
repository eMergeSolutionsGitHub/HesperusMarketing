...
public class CustomersPendingApproval {
    ...
    String[] columns = {KEY_ROW_ID, KEY_CUSTOMER_NAME, KEY_ADDRESS, KEY_AREA, KEY_TOWN, KEY_DISTRICT,
            ...
            KEY_NO_OF_STAFF, KEY_UPLOAD_STATUS, KEY_LATITUDE, KEY_LONGITUDE, KEY_GLB_PHARMACY_CODE, KEY_CUS_IMAGE, KEY_IMAGE_BLOB};
    ...
    public ArrayList<String[]> getAllCustomersPendingApproval() {
        ArrayList<String[]> customersPendingApproval = new ArrayList<String[]>();
