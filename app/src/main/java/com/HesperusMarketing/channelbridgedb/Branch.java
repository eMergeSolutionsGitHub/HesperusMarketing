...
public class Branch {
    ...
    public long insert_Branch(String ID, String DistrictID, String Town, String IsActive, String modify_date, String District,String branchcode,String bankcode) throws SQLException {
        ...
        cv.put(KEY_BRANCH_CODE, branchcode);
        cv.put(KEY_BANK_CODE, bankcode);
    ...
    public String getBranchCodeForCollection(String bank,String branch) {
        int count = 0;
        Cursor cur = null;
        String result;
        try {
