...
public class Customers {
    ...
    String[] columns = new String[]{KEY_ROW_ID, KEY_PHARMACY_ID,
            ...
            KEY_MAX_JOB_ID, KEY_IMAGE_ID, KEY_IMAGE_BLOB,KEY_IS_INVOICE_ALLOWED,KEY_MAX_INVOICE_COUNT};//add customer image  sk
    ...
    private static final String CUSTOMER_CREATE = "CREATE TABLE " + TABLE_NAME
            ...
            + KEY_MAX_INVOICE_COUNT + " INTEGER " + " );"; //add customer image  sk
    ...
    public long insertCustomer(String pharmacyId, String pharmacyCode,
                               ...
                               String maxJobId, String imageId, byte[] image,String invoiceallowd,String maxcount) throws SQLException {//add new byte image
    ...
    public long updateCustomerDetails(String pharmacyId, String pharmacyCode,
                                      ...
                                      String pharmacyRegNo, String pharmacistName,
                                      String purchasingOfficer, String noStaff, String customerCode,
                                      String maxJobId, String imageId, byte[] image,String invoiceallowd,String maxcount) throws SQLException {
    ...
    public double GetOustand_value(String selectedItem1) {
        double value = 0.0;
        try {
            String strqu = "select " + KEY_CURRENT_CREDIT + " from " + TABLE_NAME + " where " + KEY_COMPANY_CODE + " ='" + selectedItem1 + "' ";
    ...
    public String getCreditLimitByPharmacyId(String PharmacyID) {

        Cursor cur = database.rawQuery("SELECT credit_limit FROM customers where pharmacy_id =" + PharmacyID + " ", null);
        cur.moveToFirst();
