...
public class ChequesDetails {
    ...
    public long insert_Cheqes(String ID, String cusname, String collevtionnoteno, String invoiceno, String paymenttype, String chequenumber,String cheqamount,
    ...
    public ArrayList<ReportList> getDataForDealerSales(String customer, String town,String fromDate,String toDate,int searchStatus) {
        ...
        try {
            ...
            while (!cursorMain.isAfterLast()) {
                ...
                reportList.setChequAmount(cursorMain.getString(6));
