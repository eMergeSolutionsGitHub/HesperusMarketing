  ...
  /*  public long update(String Id,String dealer_code, String DealerName,
    ...
    public List<String> loadOutInvoiceNumber(String customername) {
        ...
        try {
            ...
            // String strqu = "select  DISTINCT  del.InvoiceNo,del.CreditAmount from DEL_Outstanding del inner join customers c on del.CustomerNo = c.pharmacy_code where c.CustomerNo='" + customername + "' AND CreditAmount != '0.00'";
    ...
    public List<String[]> loadOutSatingInvoiceNumberBYId(String id) {
        ...
        if(cur.getCount()==0){
            String[] outSatingData = new String[13];
            outSatingData[0] = "Null";
        }else {
            cur.moveToFirst();
            while (!cur.isAfterLast()) {
                String[] outSatingData = new String[13];
                outSatingData[0] = cur.getString(0);
                outSatingData[1] = cur.getString(1);
                outSatingData[2] = cur.getString(2);

                outSating.add(outSatingData);
                cur.moveToNext();
            }
        }
