...
public class Master_Banks {
    ...
    private static final String KEY_CODE = "BankCode";
    ...
    public long insert_Master_Banks(String ID, String CreditPeriod, String IsActive, String modify_date,String code) throws SQLException {
